...
Usage: python scripts/train.py [--iterations 10000] [--out output/blueprint.pkl]
"""
...
def main():
    ...
    ap.add_argument("--iterations", "-n", type=int, default=T_MAX_DEFAULT, help="Training iterations")
    ap.add_argument("--log-interval", type=int, default=LOG_INTERVAL)
    ap.add_argument("--out", "-o", default="output/blueprint.pkl", help="Output path for strategy")
    ...
    start = time.time()
    trainer.train(num_iterations=args.iterations, log_interval=args.log_interval)
